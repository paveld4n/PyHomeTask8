...
if __name__ == "__main__":
    write_order_to_json('Spaten', 3, 100, 'Buhaev', '08.04.2023')
    write_order_to_json('ESTRELLA', 2, 200, 'Buhaev', '08.04.2023')
    write_order_to_json('Cernovar', 3, 500, 'Buhaev', '08.04.2023')
    write_order_to_json('Guinness', 4, 700, 'Buhaev', '08.04.2023')